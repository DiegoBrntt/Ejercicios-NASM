...
msjEntrada:
db "Ingrese cant. de filas deseadas: ", 0

msjEntrada2:
db "Ingrese cant. de columnas deseadas: ", 0
...
msjMatriz2:
db "Matriz girada 90° en sentido antihorario: ", 0
...
mostrarMensajeEntrada2:  ; RUTINA PARA MOSTRAR UNA CADENA USANDO PRINTF
push msjEntrada2
push fmtString
call printf
add esp, 8
